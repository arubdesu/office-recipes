...
# multilingual. Only Production (vs. Insider Slow/Fast) option available
CULTURE_CODE = "0409"
BASE_URL = "https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/OfficeMac/%s15.xml"
PROD_DICT = {
    'Excel':'XCEL',
    'OneNote':'ONMC',
    'Outlook':'OPIM',
...
SUPPORTED_TYPES = ["Combo", "Delta", "Standalone"]
DEFAULT_TYPE = "Combo"
...
class MSOffice2016URLandUpdateInfoProvider(Processor):
    ...
    output_variables = {
        ...
        "url": {
            "description": "URL to the latest requested installer.",
        },
    }
    description = __doc__
    min_delta_version = ""
